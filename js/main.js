...
angular.module('wioflixApp')
    ...
    .controller('ImdbController', function imdbController($scope, $http) {
        ...
        $http.get('./js/imdbMovies.json').success(function (data) {
            $scope.movies = data;
        });

        // $http({
        //     method: 'GET',
        //     url: 'http://whatisonnetflix.com/js/imdbCategoriesMovies.json?version=200'
        // }).success(function (data) {
        ...
        // $http({
        //     method: 'GET',
        //     url: 'http://whatisonnetflix.com/js/imdbCategoriesTv.json?version=200'
        // }).success(function (data) {
        //     $scope.genresTv = data;
        // });
        //
        // $http({
        //     method: 'GET',
        //     url: 'http://whatisonnetflix.com/js/imdbTV.json?version=200'
        // }).success(function (data) {
        //     $scope.shows = data;
        // });
